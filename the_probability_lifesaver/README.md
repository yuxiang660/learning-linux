...
* 三门问题的解释
   ...
   * 解释2：贝叶斯定理
      * 事件A在事件B发生的条件下发生的概率，和事件B在事件A发生的条件下发生的概率是不同的，贝叶斯定理确定了这两者之间的关系
      * 假设事件A=选手不换门选对，事件B=主持人开了山羊的门
         * P(A|B)表示在主持人开了山羊的门后，选手不换门选对的概率。那么(1-P(A|B))表示在在主持人开了山羊的门后，选手换门赢的概率。
         * P(B|A)表示在选手不换门的并选对时，主持人开了山羊门的概率
            * 如果主持人事先知道门后面的情况，那么P(B|A)=1
            * 否则，由于选手已经选对，主持人肯定只能开山羊的门，因此：P(B|A)=1
         * P(A)表示选手不换选对的概率，P(A)=1/3
         * P(B)表示主持人开了山羊门的概率
